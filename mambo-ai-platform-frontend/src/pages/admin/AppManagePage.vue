...
import { listAppVoByPageByAdmin, deleteAppByAdmin, updateAppByAdmin, batchDeleteAppByAdmin, exportAppList } from '@/api/appController'
...
const handleBatchDelete = async () => {
  ...
  try {
    const res = await batchDeleteAppByAdmin({ ids })
    if (res.data.code === 0) {
